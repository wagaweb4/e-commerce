    ...
    <div>
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-start px-6 py-28 lg:px-10 lg:py-40">
          ...
          <h1 className="mt-6 max-w-2xl font-display text-5xl font-light leading-[1.1] text-cream lg:text-7xl">
            L&apos;élégance,
            <br />
            sans excès.
          </h1>
          <p className="mt-6 max-w-md text-base font-light leading-relaxed text-cream/80">
          ...
          <Link
            ...
            className="mt-10 inline-flex items-center gap-3 border border-cream px-8 py-3.5 text-sm font-light tracking-wide text-cream transition-colors duration-300 hover:bg-cream hover:text-forest"
          >
